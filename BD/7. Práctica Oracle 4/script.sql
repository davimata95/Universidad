--Contar las reservas que hay de esa fila y esa columna, y si hay más de una, se hace un rollback para que no se reserve más de 1 vez
...
select decode(:v_error,'false','"C:\fernan\docs\docencia\asignaturas\BD DG\2013-2014\Pr?cticas\6. Pr?ctica 4 Oracle Transacciones\preguntar.sql"','"C:\fernan\docs\docencia\asignaturas\BD DG\2013-2014\Pr?cticas\6. Pr?ctica 4 Oracle Transacciones\no_preguntar.sql"') as SCRIPT_COL from dual;
print :v_error
