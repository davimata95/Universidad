...
import tp.pr5.vistas.VistaSwing;
...
public class Main {
	...
	public static void main(java.lang.String[] args){
		...
		opcion.addOption(OptionBuilder	.withArgName("game")
										.withLongOpt("game")
										.hasArg().withDescription("Tipo de juego (c4, co, gr, rv). Por defecto, c4.")
										.create("g"));
		...
		else if (tipoJuego.equalsIgnoreCase("rv")){
			if (numArgs.length > 0){
				argumentosInvalidos(numArgs);
			}
			else {
